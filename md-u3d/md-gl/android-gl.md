# 1.ndk jni代码中用的是gles 3，Java代码中是否要设置gles 3的环境，如何设置
...
===========================================
# 3. JNI层与Java层GLES 3.0上下文联动的关键注意点（如避免多线程调用冲突）
...
========================================================
# 4.写一个包含“GL线程安全调用”和“资源同步释放”的**JNI层示例代码**（如初始化Shader、绘制三角形）
...
========================================================
# 5. EGLview.java :setEGLContextFactory(new ContextFactory())
...
==============================================================
# 6.osgearth_viewer_android\src\osg\AndroidExample\EGLview.java代码中关于 gles 版本的设置是否正确?
