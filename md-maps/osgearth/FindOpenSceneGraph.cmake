#  osgearth/cmake/FindOpenSceneGraph.cmake
#
# 手动指定源码编译的 OSG 路径（替换为你的实际路径）
message(STATUS "............../mnt/disk2/abner/zdev/nv/osgearth/cmake/FindOpenSceneGraph.cmake;;;OpenSceneGraph_ROOT=${OpenSceneGraph_ROOT}\n")
...
foreach(component ${OpenSceneGraph_FIND_COMPONENTS})
    ...
    if( ${component}_LIBRARY )
        list(APPEND OpenSceneGraph_LIBRARIES ${${component}_LIBRARY})
    else()
